...
HD_PWD='/home/parallels/Desktop/elaborato_754/mutilplexer_ieee754/mutilplexer_ieee754.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log tl.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source tl.tcl -notrace
