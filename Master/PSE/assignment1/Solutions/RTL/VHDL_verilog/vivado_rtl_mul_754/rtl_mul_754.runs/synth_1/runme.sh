...
HD_PWD='/home/parallels/Desktop/elaborato_754/mutilplexer_ieee754/mutilplexer_ieee754.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tl.tcl
